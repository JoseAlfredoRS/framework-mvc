...
class Validation
{
    ...
    public function min($length)
    {
        ...
        if (is_string($this->value)) {
            ...
            if (strlen($this->value) < $length) {
                $this->errors[] = 'Valor campo ' . $this->name . ' inferior al valor minimo';
            }
        } else {
    ...
    public function max($length)
    {
        ...
        if (is_string($this->value)) {
            ...
            if (strlen($this->value) > $length) {
                $this->errors[] = 'Valor campo ' . $this->name . ' superior al valor maximo';
            }
        } else {
    ...
    public function equal($value)
    {
        ...
        if ($this->value != $value) {
            $this->errors[] = 'Valor campo ' . $this->name . ' no corrispondente.';
        }
        return $this;
    }
    ...
    public function maxSize($size)
    {
        ...
        if ($this->file['error'] != 4 && $this->file['size'] > $size) {
            $this->errors[] = 'El archivo ' . $this->name . ' supera la dimensión máxima de ' . number_format($size / 1048576, 2) . ' MB.';
        }
        return $this;
    }
